...
bool_t
xdr_qcsapi_remove_params_rpcdata (XDR *xdrs, qcsapi_remove_params_rpcdata *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_pointer (xdrs, (char **)&objp->SSID_substr, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->remove_params, sizeof (__rpc_qcsapi_set_parameters), (xdrproc_t) xdr___rpc_qcsapi_set_parameters))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_regulatory_get_country_code_rpcdata (XDR *xdrs, qcsapi_regulatory_get_country_code_rpcdata *objp)
{
	register int32_t *buf;
