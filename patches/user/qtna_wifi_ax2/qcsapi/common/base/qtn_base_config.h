...
#define PEARL_PHY1_ADDR2		8
#define PEARL_PHY10_ADDR		8
...
#ifdef PEARL_PLATFORM_B0
#define CONFIG_ARCH_RGMII_BBIC5_EVK	0
#else
#define CONFIG_ARCH_RGMII_BBIC5_EVK	0x81818088
#endif
...
#define EMAC_PHY_RTL8363SC_SWITCH	(BIT(29))
#define EMAC_XFI			(BIT(30))
...
/* DDR Size */
#define DDR_512MB		(512*1024*1024)
...
/* Device ID */
#define PCIE_DEV_ID				(0x8)
#define PCIE_DEV_ID_PEARL			(0x9)
#define PCIE_DEV_ID_JADE			(0xa)
...
#define PCIE_CFG_DEV_ID_MASK			(0xff << 16)
#define PCIE_CFG_DEV_ID_OFFSET			(16)
...
/* PCIe Gen3 IP advertising only 5Gbps speed in TARGET_LINK_SPEED */
#define PCIE_ENDPOINT_GEN3_5G			(PCIE_GEN3 | PCIE_IN_USE | \
							PCIE_CFG_TARGET_LINK_SPEED_VEC1)
...
/* BBIC6 PCIe defines */
#define PCIE_ENDPOINT_BBIC6			((PCIE_DEV_ID_JADE << PCIE_CFG_DEV_ID_OFFSET) | PCIE_ENDPOINT)

/* IO voltage control */
#define DEFAULT_IO_VOLTAGE_CTRL			(0x4)
#define IO_VOLTAGE_CTRL_C0_EVK			(0xc)
#define IO_VOLTAGE_CONTROL			(0xc)
#define IO_VOLTAGE_CTRL_U84P8			(0xaad)

#define IO_VOLT_CTRL_PCIE_VREG_BYPASS		(BIT(0))
#define EMACSS_SPARE0_MASK			(0xffe)

/* Clock gating defines */
#define CLK_GATE_DIS_DSP0			(BIT(0))
#define CLK_GATE_DIS_DSP1			(BIT(1))
#define CLK_GATE_DIS_UUC			(BIT(2))
#define CLK_GATE_DIS_WMAC1			(BIT(3))
#define CLK_GATE_PCIE_GEN3			(BIT(4))
#define CLK_GATE_EMAC10				(BIT(5))
#define CLK_GATE_WMAC1_RXHDP			(BIT(6))
#define CLK_GATE_BB1				(BIT(7))
#define CLK_GATE_SLEEP_PCIE_GEN3		(BIT(8))
#define CLK_GATE_SLEEP_EMAC10			(BIT(9))
#define CLK_GATE_SLEEP_WMAC1_RXHDP		(BIT(10))
#define CLK_GATE_SLEEP_BB1			(BIT(11))
#define CLK_GATE_SLEEP_WMAC1			(BIT(12))

#define DEFAULT_CLK_GATE_PARAM			(0)
#define CLK_GATE_PCIE_PLATFORM			(0x1fff)

/* PMIC voltage control */
#define DEFAULT_PMIC_VOLT_CTRL			(0x0)
#define PMIC_WLS_VOLT_RFIC8			(0x8)
#define PMIC_WLS_VOLT_RFIC8_RFIC6		(0x8)
#define PMIC_WLS_VOLT_RFIC10			(0xa)
#define PMIC_WLS_VOLT_RFIC10_RFIC842		(0xa)
