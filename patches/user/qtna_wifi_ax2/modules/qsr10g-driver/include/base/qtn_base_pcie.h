...
#define PCIE_HDP_PHY_CR(base)			((base) + 0x2cc4)
...
#define PCIE_INDIRECT_ACC_ADDR(base)		((base) + 0x2fa4)
#define PCIE_INDIRECT_ACC_DATA(base)		((base) + 0x2fa8)
...
#define PCIE_MISC_CTL_1(base)			((base) + 0x08bc)
...
#define PCIE_LINK_CAP(base)			((base) + 0x007c)
...
#define	PCIE_BAR_SYSCTL_LEN		(PCIE_BAR_ATU_MIN_SIZE - 1)
...
#define	PCIE_BAR_SHMEM_LO		CONFIG_ARC_PCIE_BASE
#define	PCIE_BAR_SHMEM_HI		0x00000000

#define	PCIE_BAR_DMAREG			3
#define	PCIE_BAR_DMAREG_LEN		(PCIE_BAR_ATU_MIN_SIZE - 1)
