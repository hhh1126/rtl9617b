...
/* Rename these macros so that active scan can support multiple slots */
#define IEEE80211_PICK_BG_MULTI_SLOTS_FAST	0x0020
#define IEEE80211_PICK_BG_MULTI_SLOTS_NORMAL	0x0040
#define IEEE80211_PICK_BG_MULTI_SLOTS_SLOW	0x0080
#define IEEE80211_PICK_BG_MULTI_SLOTS_AUTO	0x4000
#define IEEE80211_PICK_BG_FAKE_PS		0x2000
/* Keep these macros for back-forward compatibility */
#define IEEE80211_PICK_BG_PASSIVE_FAST		IEEE80211_PICK_BG_MULTI_SLOTS_FAST
#define IEEE80211_PICK_BG_PASSIVE_NORMAL	IEEE80211_PICK_BG_MULTI_SLOTS_NORMAL
#define IEEE80211_PICK_BG_PASSIVE_SLOW		IEEE80211_PICK_BG_MULTI_SLOTS_SLOW

#define IEEE80211_PICK_BG_MODE_MASK		(IEEE80211_PICK_BG_ACTIVE |		\
						IEEE80211_PICK_BG_MULTI_SLOTS_FAST |	\
						IEEE80211_PICK_BG_MULTI_SLOTS_NORMAL |	\
						IEEE80211_PICK_BG_MULTI_SLOTS_SLOW |	\
						IEEE80211_PICK_BG_MULTI_SLOTS_AUTO |	\
						IEEE80211_PICK_BG_FAKE_PS)
#define IEEE80211_PICK_CONTROL_MASK		(IEEE80211_PICK_BG_MODE_MASK | \
						IEEE80211_PICK_SCAN_FLUSH)
#define IEEE80211_PICK_BG_CHECK			0x8000	/* scan background with the check of beacon conflicts */

#define IEEE80211_PICK_ALGORITHM_MASK	0x1F00
...
/*
 * Select a valid lower 80M channel for WCAC
 */
#define IEEE80211_SCAN_PICK_L80M_CHAN_FOR_WCAC			0x00140000
