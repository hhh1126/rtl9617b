...
#ifdef JADE_PLATFORM
#define QTN_RX_DATA_PATH_PIPELINE		1
...
#define JADE_FCS_CHAIN_MODE			1
#define QTN_HAS_SPATIAL_REUSE_SUPPORT		1
#else
#define QTN_RX_DATA_PATH_PIPELINE		0
...
#define JADE_WAR_USE_OLD_BM_TX_STATUS		0
#define JADE_FCS_CHAIN_MODE			0
#define QTN_HAS_SPATIAL_REUSE_SUPPORT		0
#endif /* JADE_PLATFORM */

#if QTN_RX_DATA_PATH_PIPELINE
#define AUC_RX_OFFLOAD_PIPELINE_NUM	2
#else
#define AUC_RX_OFFLOAD_PIPELINE_NUM	0
#endif

#ifdef JADE_PLATFORM
#define AUC_ADMA				JADE_USE_TQE_COMPRESSED_DESC
...
#define AUC_UL_OFDMA_FROM_RUC			1
#define AUC_MULTI_USER_TX_STATUS		1
#define AUC_HW_MTID_ENCRYPTION			1
#define AUC_UPLINK_SCHEDULER			1
#define AUC_UPLINK_SCHEDULER_ENABLED		0
#else
#define AUC_ADMA				0
...
#define AUC_UL_OFDMA_FROM_RUC			0
#define AUC_MULTI_USER_TX_STATUS		0
#define AUC_HW_MTID_ENCRYPTION			0
...
#define HE_PERIODIC_TRIGGERTX	PEARL_11AX_ENABLED
#define PEARL_11AX_RX_TRIGGER	PEARL_11AX_ENABLED
...
#ifdef JADE_PLATFORM
#define JADE_USE_HW_PSDU_LEN_CALC	PEARL_11AX_ENABLED
#else
