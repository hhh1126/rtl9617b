...
xdr___rpc_qcsapi_channel_power_table (XDR *xdrs, __rpc_qcsapi_channel_power_table *objp)
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		 if (!xdr_uint8_t (xdrs, &objp->channel))
			 return FALSE;
		buf = XDR_INLINE (xdrs, ( 16  + 16  + 16  + 16 ) * BYTES_PER_XDR_UNIT);
		if (buf == NULL) {
			 if (!xdr_vector (xdrs, (char *)objp->power_20M, 16,
				sizeof (int), (xdrproc_t) xdr_int))
				 return FALSE;
			 if (!xdr_vector (xdrs, (char *)objp->power_40M, 16,
				sizeof (int), (xdrproc_t) xdr_int))
				 return FALSE;
			 if (!xdr_vector (xdrs, (char *)objp->power_80M, 16,
				sizeof (int), (xdrproc_t) xdr_int))
				 return FALSE;
			 if (!xdr_vector (xdrs, (char *)objp->power_160M, 16,
				sizeof (int), (xdrproc_t) xdr_int))
				 return FALSE;
		} else {
			{
...
xdr___rpc_qtn_nis_all_node (XDR *xdrs, __rpc_qtn_nis_all_node *objp)
{
	...
	int i;
	 ...
	 if (!xdr_uint16_t (xdrs, &objp->flags))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->val, 4,
		sizeof (uint32_t), (xdrproc_t) xdr_uint32_t))
		 return FALSE;
	return TRUE;
}
...
bool_t
xdr_qcsapi_wifi_get_vap_default_state_rpcdata (XDR *xdrs, qcsapi_wifi_get_vap_default_state_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_vap_default_state_rpcdata (XDR *xdrs, qcsapi_wifi_set_vap_default_state_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_tx_chains_rpcdata (XDR *xdrs, qcsapi_wifi_set_tx_chains_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->tx_chains))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_rx_chains_rpcdata (XDR *xdrs, qcsapi_wifi_set_rx_chains_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->rx_chains))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_get_vco_lock_detect_mode_rpcdata (XDR *xdrs, qcsapi_wifi_get_vco_lock_detect_mode_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_vco_lock_detect_mode_rpcdata (XDR *xdrs, qcsapi_wifi_set_vco_lock_detect_mode_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_txburst_rpcdata (XDR *xdrs, qcsapi_wifi_set_txburst_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_txburst_rpcdata (XDR *xdrs, qcsapi_wifi_get_txburst_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_ieee80211r_nas_id_rpcdata (XDR *xdrs, qcsapi_wifi_get_ieee80211r_nas_id_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_get_core_dump_rpcdata (XDR *xdrs, qcsapi_get_core_dump_rpcdata *objp)
{
	register int32_t *buf;
