...
#define BOARD_PM_GOVERNOR_SIGNAL		"signal"
#define BOARD_PM_GOVERNOR_NSM			"nsm"
#define BOARD_PM_GOVERNOR_BATTERY		"battery"
...
/* FIXME: current the hardware reset can't work well, so software reset is used */
#define BOARD_MAC_BB_IS_HRESET	0
...
#define QTN_PM_PARAM_DEFAULTS	{							\
	...
	BOARD_MAC_BB_IS_HRESET,			/* QTN_PM_SUSPEND_HRESET */		\
