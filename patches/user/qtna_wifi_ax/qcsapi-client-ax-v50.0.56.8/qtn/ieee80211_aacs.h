...
struct aacs_chan_bw {
	...
	int32_t		aacs_index;
	uint8_t		aacs_chan_num;
	uint8_t		aacs_bw;
	uint8_t		aacs_cchan; /* Center channel */
	uint32_t	aacs_cfreq; /* Center freq (MHz) */
	uint8_t		aacs_sec80ll;
	uint8_t		aacs_lowest_chan_num;
...
#define AACS_WIFI_MODE_HT	0
#define AACS_WIFI_MODE_VHT	1
...
#define IEEE80211_AACS_CHAN_MAX		255
...
struct ieee80211_aacs_ctx {
	...
	uint8_t aacs_chan_hash_map[IEEE80211_AACS_BW_MAX][IEEE80211_AACS_CHAN_MAX];
...
struct aacs_chan_bw *ieee80211_aacs_pick_initial_channel(struct ieee80211_aacs_ctx *aacs);
